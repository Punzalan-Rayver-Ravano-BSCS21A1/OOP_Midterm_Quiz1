...
public class EncapsulationTests
{
    ...
    public void TestBalanceDirectAccess()
    {
        ...
        account.Balance = 1000;  // Should not be accessible directly
    ...
    {
        BankAccount account = new BankAccount("Savings", 500);
        Assert.ThrowsException<ArgumentException>(() =>  account.Deposit(-200));  
    ...
    {
        BankAccount account = new BankAccount("Savings", 500);
        Assert.ThrowsException<ArgumentException>(() => account.Withdraw(600));  // Should not allow overdraw
        Assert.AreEqual(500, account.GetBalance());
    }
    ...
    public void TestProtectedEmployeeIdAccess()
    {
        ...
        string empId = emp.setEmployee;  // Should not be accessible directly
    ...
    public void TestModifyEmployeeIdInManager()
    {
        ...
        manager.setEmployee = "M002";  // Should not be accessible directly
    ...
    {
        Customer customer = new Customer("John Doe", 25);
        Assert.IsFalse(customer.GetType().GetMethod("GetEmployeeId") != null);
    }
